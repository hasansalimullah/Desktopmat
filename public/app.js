...
function renderInfoPage(page) {
  const pages = {
    ...
    returns: ['Returns', ['We want your desk setup to feel right. If you need to request a return for a defective product, email desktopmatinfo@gmail.com with your order reference, the item you want to return, and a brief explanation of the issue.', 'Please contact us before mailing anything back so we can confirm the correct return instructions. Returns are accepted for defective products only and must be requested within 15 days of receiving your order. Items should be new, unused, and protected during transit whenever possible. Exchanges are not accepted.', 'Once an approved defective return is received and checked, we will process your refund within 15 days. We do not charge restocking fees. Customers are responsible for downloading, printing, and paying for the return shipping label and return shipping costs. Original shipping charges may be refundable if the product arrived defective or there was an error with the order.']],
